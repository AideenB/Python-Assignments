...
3. euler5.py <br>
*This program is written to prove problem set number 5 from Project Euler - https://projecteuler.net/problem=5 This problem posits that 2,520 is the smallest number that can be divided by each of the numbers from 1 to 10 without any remainder. The program uses for and range to calculate the smallest positive number that is evenly divisible by all of the numbers from 1 to 20. 
